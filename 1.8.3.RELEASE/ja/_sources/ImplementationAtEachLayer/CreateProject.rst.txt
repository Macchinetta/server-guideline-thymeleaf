...
.. note:: **プロジェクト構成の原則**
    ...
    詳細については\ `チュートリアル <https://github.com/Macchinetta/tutorial-apps-thymeleaf/tree/1.8.3.RELEASE/secure-login-demo/secure-login>`_\ を参考にされたい。
 ...
 * 詳しくは、 `The Resources Component <https://tomcat.apache.org/tomcat-9.0-doc/config/resources.html>`_\ と `atrs-envのconfigsフォルダ <https://github.com/Macchinetta/atrs-thymeleaf/tree/1.8.3.RELEASE/atrs-env/configs>`_\ を参考されたい。
 * リソースの設定例：
