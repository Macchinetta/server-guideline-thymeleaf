...
Mavenのアーキタイプを利用し、\ `Macchinetta Server Framework (1.x)のブランクプロジェクト <https://github.com/Macchinetta/macchinetta-web-blank-thymeleaf/tree/1.8.4.RELEASE>`_\ を作成する。
...
.. code-block:: xml
    :emphasize-lines: 21-23,82-84,93-95
